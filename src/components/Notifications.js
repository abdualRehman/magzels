...
import { Typography, Grid, FormControlLabel, Checkbox, Button, FormGroup } from "@mui/material";
    ...
    <>
      ...
      <Grid container spacing={2} px={{ sm: 3, lg: 4 }}>
        <Grid item xs={12}>
          <FormGroup>
            <FormControlLabel
              componentsProps={{ typography: { variant: 'subtitle1', fontWeight: 500, lineHeight: { sm: 2, lg: 3 } } }}
              control={
                <Checkbox
                  color="success"
                  checked={notification.like_notify}
                  onChange={e => {
                    setNotification({ ...notification, like_notify: e.target.checked })
                  }}
                  sx={{ "& .MuiSvgIcon-root": { sm: { fontSize: 20, paddingRight: 1 }, lg: { fontSize: 28, paddingRight: 2 } }, }}
                />
              }
            ...
            <FormControlLabel
              ...
              control={
                <Checkbox
                  ...
                  onChange={e => {
                    setNotification({ ...notification, comment_notify: e.target.checked })
                  }}
                  sx={{ "& .MuiSvgIcon-root": { sm: { fontSize: 20, paddingRight: 1 }, lg: { fontSize: 28, paddingRight: 2 } }, }}
                />
              }
            ...
            <FormControlLabel
              ...
              control={
                <Checkbox
                  ...
                  onChange={e => {
                    setNotification({ ...notification, shares_notify: e.target.checked })
                  }}
                  sx={{ "& .MuiSvgIcon-root": { sm: { fontSize: 20, paddingRight: 1 }, lg: { fontSize: 28, paddingRight: 2 } }, }}
                />
              }
            ...
            <FormControlLabel
              ...
              control={
                <Checkbox
                  ...
                  onChange={e => {
                    setNotification({ ...notification, follow_me_notify: e.target.checked })
                  }}
                  sx={{ "& .MuiSvgIcon-root": { sm: { fontSize: 20, paddingRight: 1 }, lg: { fontSize: 28, paddingRight: 2 } }, }}
                />
              }
            ...
            <FormControlLabel
              ...
              control={
                <Checkbox
                  ...
                  onChange={e => {
                    setNotification({ ...notification, mention_me_notify: e.target.checked })
                  }}
                  sx={{ "& .MuiSvgIcon-root": { sm: { fontSize: 20, paddingRight: 1 }, lg: { fontSize: 28, paddingRight: 2 } }, }}
                />
              }
            ...
            <FormControlLabel
              ...
              control={
                <Checkbox
                  ...
                  onChange={e => {
                    setNotification({ ...notification, join_my_group_notify: e.target.checked })
                  }}
                  sx={{ "& .MuiSvgIcon-root": { sm: { fontSize: 20, paddingRight: 1 }, lg: { fontSize: 28, paddingRight: 2 } }, }}
                />
              }
